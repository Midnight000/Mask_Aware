...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        self, model, x, t, clip_denoised=None, denoised_fn=None, model_kwargs=None, pred_only=False
    ):
        """
    ...
    def p_sample(
        ...
        def loss_fn(_x0, _pred_x0, _mask):
            ret = th.sum((_x0 * _mask - _pred_x0 * _mask) ** 2)
            return ret
        def reg_fn(_origin_xt, _xt):
            ret = th.sum((_origin_xt - _xt) ** 2)
            return ret
